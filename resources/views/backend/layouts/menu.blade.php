        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown {{ request()->routeIs('category.*') ? 'show' : ''}}" id="sidebarCategory">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown {{ request()->routeIs('product.*') ? 'show' : ''}}" id="sidebarProduct">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('product.index')}}" class="nav-link {{ request()->routeIs('product.index') ? 'active' : ''}}" data-key="t-crm"> View All </a>
                            </li>
                            <li class="nav-item">
